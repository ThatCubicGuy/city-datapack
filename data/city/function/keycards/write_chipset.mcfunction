execute unless data entity @s equipment.offhand.components."minecraft:custom_data"{"city:item": "keycard"} run return fail
execute unless data entity @s SelectedItem.components."minecraft:custom_data"{"city:item": "circuit_board"} run return fail
